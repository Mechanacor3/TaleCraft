...
const TextToSpeech: React.FC = () => {
    ...
    return (
        <div className="text-to-speech">
            ...
            />
            <select value={voiceStyle} onChange={handleVoiceChange} className="mt-2 p-2 border border-gray-300 rounded">
                <option value="default">Default Voice</option>
                <option value="voice1">Voice Style 1</option>
                <option value="voice2">Voice Style 2</option>
                {/* Add more voice styles as needed */}
            </select>
            <button onClick={generateAudio} className="mt-2 p-2 bg-blue-500 text-white rounded">
                Generate Audio
            </button>
            {audioUrl && (
                <div className="mt-4">
